...
class _PaymentState extends State<Payment> {
  ...
  void openCheckout(){
    ...
    var options={
      ...
      "prefill":{
        "contact":"8921947665",
        "email": "bobybijukurian@gmail.com",
      },
      "external":{
        "wallets":["paytm"],
                ...
                child: Container(height: 350, decoration: BoxDecoration(color: Colors.grey[200],borderRadius: BorderRadius.circular(8.0),
                  ...
                  child: Column(
                    children: [
                      ...
                      },child: Text('Cash On Site',style: TextStyle(color: Colors.white),),color: Colors.black,elevation: 4,shape: RoundedRectangleBorder(borderRadius: new BorderRadius.circular(30.0)))
                    ],
                  ),
                ),
              ),
